...
class BlacklistServices(
    ...
    fun applyToFilmList() {
        ...
        val blacklistSnapshot = rules.toList()
    ...
    fun createDownloadsPredicate(): Predicate<DatenFilm> {
        ...
        val blacklistPredicate: Predicate<DatenFilm> =
            if (rules.isEmpty()) Predicate { true } else ApplyBlacklistFilterPredicate(rules.toList())
    ...
    private class GeoblockingPredicate : Predicate<DatenFilm> {
        /**
