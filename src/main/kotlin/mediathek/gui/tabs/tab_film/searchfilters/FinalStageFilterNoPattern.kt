...
class FinalStageFilterNoPattern(searchStr: Array<String>) : Predicate<DatenFilm> {
    private val searchText = searchStr[0]

    override fun test(film: DatenFilm): Boolean = film.matchesTopicOrTitle(searchText)
}
