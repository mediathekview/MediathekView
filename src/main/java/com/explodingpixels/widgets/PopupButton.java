...
public class PopupButton<E> {
    ...
    private final JButton fButton = new CustomJButton();

    private final List<E> fPopupItemsList;

	private E fSelectedItem;

    private final JPopupMenu fPopupMenu = new JPopupMenu();
