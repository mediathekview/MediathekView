...
public class HelpPanel extends javax.swing.JPanel {
    ...
    public HelpPanel(JFrame pparent, Daten ddaten) {
        ...
        jButtonHilfeReset.addActionListener(e -> new DialogHilfe(daten.getMediathekGui(), true, new GetFile().getHilfeSuchen(GetFile.PFAD_HILFETEXT_RESET)).setVisible(true));
