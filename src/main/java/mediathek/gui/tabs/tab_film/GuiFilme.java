  ...
  private synchronized void saveFilm(DatenPset pSet) {
    ...
    for (DatenFilm datenFilm : liste) {
      ...
      if (standard) {
        ...
        datenDownload =
            new DatenDownload(
                pSet, datenFilm, DatenDownload.QUELLE_DOWNLOAD, null, "", pfad, "" /*Auflösung*/);
  ...
  private void setupActionListeners() {
    Platform.runLater(
        () -> {
          ...
          fap.searchThroughDescription.addListener(
              (os, o, n) -> {
