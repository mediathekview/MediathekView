...
public class ApplicationConfiguration {
    ...
    public static final String APPLICATION_UI_AUDIOTHEK_SEARCH_HISTORY = "application.ui.audiothek.search.history";
    ...
    public static final String DOWNLOAD_USE_CDN_AWARE_DIRECT_DOWNLOAD = "download.cdn_aware_direct_download.use";
