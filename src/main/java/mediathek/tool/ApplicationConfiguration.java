...
public class ApplicationConfiguration {
    ...
    public static final String FILMLIST_EXTEND_OLD_LIST = "filmlist.extend_old_filmlist";
    ...
    private static class LazyHolder {
        static final ApplicationConfiguration INSTANCE = new ApplicationConfiguration();
    }
