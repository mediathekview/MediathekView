...
class ThreeSatParserTest {
    @Test
    fun testParenthesizedSlashNotation() {
        val title = "37°: Kreative Köpfe (S2025/E11)"
        val result = manager.parse("3Sat", title)
    ...
    @Test
    fun testParenthesizedHyphenNotation() {
        val title = "Sendung (S2023-E05) Spezial"
        val result = manager.parse("3Sat", title)
