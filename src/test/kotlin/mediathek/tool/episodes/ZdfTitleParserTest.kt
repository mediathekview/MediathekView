...
class ZdfTitleParserTest {
    @Test
    fun testParenthesizedSlashYearPattern() {
        val title = "heute-show vom 14. Februar 2025 - Nachrichtensatire mit Oliver Welke (S2025/E03)"
        val result = manager.parse("ZDF", title)
    ...
    @Test
    fun testParenthesizedContinuousYearPattern() {
        val title = "April 2024 (S2024E11) (Gebärdensprache)"
        val result = manager.parse("ZDF", title)
    ...
    @Test
    fun testParenthesizedSlashNonYearPattern() {
        val title = "Eine kleine Sehnsucht (S07/E10)"
        val result = manager.parse("ZDF", title)
    ...
    @Test
    fun testParenthesizedContinuousNonYearPattern() {
        val title = "Ein heißer Tanz (S01E16)"
        val result = manager.parse("ZDF", title)
    ...
    @Test
    fun testUnparenthesizedSlashPattern() {
        val title = "heute journal update vom 2. Juni 2025 S2025/E102"
        val result = manager.parse("ZDF", title)
    ...
    @Test
    fun testNegativeCaseNoMatch() {
        val title = "heute-show vom 13. September 2024 - Nachrichtensatire mit Oliver Welke"
        val result = manager.parse("ZDF", title)
