...
internal class GuiFunktionenProgrammeTest {
    @TempDir
    ...
    @Test
    fun checkPathWriteableWithoutCreatingLeavesMissingTargetDirectoryUncreated() {
        val missingTargetDirectory = tempDirectory.resolve("queued-download")

        assertTrue(GuiFunktionenProgramme.checkPathWriteableWithoutCreating(missingTargetDirectory.toString()))
        assertFalse(missingTargetDirectory.exists())
    }

    private companion object {
        private const val URL =
            "https://pd-videos.daserste.de/int/2025/12/05/54fb90c6-8f50-42ca-b0c0-3b488af1d2be/JOB_576107__sendeton_1920x1080-50p-5000kbit.mp4"
    }
}
