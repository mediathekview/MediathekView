...
public class Konstanten {
    ...
    public static final int SYSTEM_NOTIFICATION_NR = 68;
    public static final String SYSTEM_DIALOG_DOWNLOAD_D_STARTEN = "Dialog-Download-D-Starten";
    public static final int SYSTEM_DIALOG_DOWNLOAD_D_STARTEN_NR = 69;
    public static final String SYSTEM_PLAYER_ABSPIELEN = "Player-zum-Abspielen";
    public static final int SYSTEM_PLAYER_ABSPIELEN_NR = 70;
    ...
    public static final int SYSTEM_MAX_ELEM = 72;
    public static final String[] SYSTEM_COLUMN_NAMES = {SYSTEM_ECHTZEITSUCHE, SYSTEM_LOOK, SYSTEM_USER_AGENT_AUTO, SYSTEM_USER_AGENT, SYSTEM_VERSION,
        ...
        SYSTEM_NOTIFICATION, SYSTEM_DIALOG_DOWNLOAD_D_STARTEN, SYSTEM_PLAYER_ABSPIELEN, SYSTEM_PFADE_SPEICHERN
    };
    //
}
