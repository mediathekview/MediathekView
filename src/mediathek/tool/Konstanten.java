...
public class Konstanten {
    ...
    public static final int SYSTEM_LETZTEN_PFAD_ANZEIGEN_NR = 66;
    public static final String SYSTEM_LETZTER_PFAD_SPEICHERN = "Letzer-Pfad-zum-Speichern";
    ...
    public static final String[] SYSTEM_COLUMN_NAMES = {SYSTEM_ECHTZEITSUCHE, SYSTEM_LOOK, SYSTEM_USER_AGENT_AUTO, SYSTEM_USER_AGENT, SYSTEM_VERSION,
        ...
        SYSTEM_LETZTER_PFAD_SPEICHERN, SYSTEM_BUTTON_TOOLBAR,
