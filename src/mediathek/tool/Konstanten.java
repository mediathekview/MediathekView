...
public class Konstanten {
    ...
    public static final int SYSTEM_BREITE_MELDUNGEN_NR = 61;
    public static final String SYSTEM = "system";
    public static final int SYSTEM_MAX_ELEM = 62;
    public static final String[] SYSTEM_COLUMN_NAMES = {SYSTEM_ECHTZEITSUCHE, SYSTEM_LOOK, SYSTEM_USER_AGENT_AUTO, SYSTEM_USER_AGENT, SYSTEM_VERSION,
        ...
        SYSTEM_ANSICHT_SET_LANG, SYSTEM_ICON_STANARD, SYSTEM_ICON_PFAD, SYSTEM_BREITE_MELDUNGEN
    };
    //
}
