...
public class Konstanten {
    ...
    public static final int SYSTEM_BLACKLIST_IST_WHITELIST_NR = 52;
    public static final String SYSTEM_VERSION_PROGRAMMSET = "Version-Programmset";
    public static final int SYSTEM_VERSION_PROGRAMMSET_NR = 53;
    public static final String SYSTEM = "system";
    public static final int SYSTEM_MAX_ELEM = 54;
