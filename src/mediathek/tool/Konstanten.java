...
//    public static final int SYSTEM_GEO_MELDEN_NR = 78;
    public static final String SYSTEM_GEO_STANDORT = "Geo-Standort";
//    public static final int SYSTEM_GEO_STANDORT_NR = 79;
    public static final String SYSTEM = "system";
    public static final int SYSTEM_MAX_ELEM = 80;
    public static final String[] SYSTEM_COLUMN_NAMES = {SYSTEM_ECHTZEITSUCHE, SYSTEM_LOOK, SYSTEM_USER_AGENT_AUTO, SYSTEM_USER_AGENT,
        ...
        SYSTEM_ABOS_SOFORT_SUCHEN, SYSTEM_ZIELNAMEN_ANPASSEN, SYSTEM_HINWEIS_NR_ANGEZEIGT,
        SYSTEM_ORDNER_OEFFNEN, SYSTEM_URL_OEFFNEN,
        SYSTEM_BLACKLIST_ZUKUNFT_NICHT_ANZEIGEN, SYSTEM_BLACKLIST_AUCH_ABO, SYSTEM_BLACKLIST_AUSGESCHALTET, SYSTEM_BLACKLIST_IST_WHITELIST, SYSTEM_BLACKLIST_FILMLAENGE,
        ...
        SYSTEM_ANSICHT_SET_LANG, SYSTEM_ICON_STANDARD, SYSTEM_ICON_PFAD, SYSTEM_BREITE_MELDUNGEN, SYSTEM_BANDBREITE_KBYTE, SYSTEM_DOWNLOAD_SOFORT_STARTEN,
