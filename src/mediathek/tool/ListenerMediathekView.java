...
public class ListenerMediathekView implements EventListener {
    ...
    public static final int EREIGNIS_PANEL_BESCHREIBUNG_ANZEIGEN = 24;
    public static final int EREIGNIS_SUCHFELD_FOCUS_SETZEN = 25;
    ...
    public static final int EREIGNIS_GEO = 30;
