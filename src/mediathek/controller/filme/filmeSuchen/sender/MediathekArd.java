...
public class MediathekArd extends MediathekReader implements Runnable {
    ...
    public MediathekArd(FilmeSuchen ssearch) {
        super(ssearch, /* name */ SENDER, /* text */ "ARD  (bis ca. 550 MB, bis 10.000 Filme)", /* threads */ 4, /* urlWarten */ 500);
    }
        ...
        boolean filmLaden(String urlFeed, String urlFilm, String thema, String titel, String datum, String zeit, boolean alt) {
            ...
            if (pos1 != -1) {
                ...
                if (flash) {
                    ...
                    film = new DatenFilm(senderName, thema, urlFeed, titel, urlRtmp, urlOrg /* orgUrl */, urlRtmp, datum, zeit);
                } else {
