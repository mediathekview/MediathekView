 ...
 *  @author
 */
public class MediathekOrf_1 extends MediathekReader implements Runnable {
     ...
     *  @param ddaten
     */
    public MediathekOrf_1(FilmeSuchenSender ssearch, int startPrio) {
    ...
    private class OrfThemaLaden implements Runnable {
        ...
        public synchronized void run() {
            try {
                meldungAddThread();
                String[] link;
                while ((link = getListeThemen()) != null) {
                    try {
