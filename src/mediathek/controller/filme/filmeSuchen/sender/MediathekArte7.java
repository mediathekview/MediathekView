        ...
        if ((pos = strSeite.indexOf(START, pos)) != -1) {
            while (!Daten.filmeLaden.getStop() && (pos = strSeite.indexOf(MUSTER_URL, pos)) != -1) {
                ...
                if (pos1 != -1 && pos2 != -1 && pos1 != pos2) {
                    ...
                    if (url.equals("")) {
                        Log.fehlerMeldung(-762138540, "MediathekArte.addToList__", "keine URL" + nameSenderMReader + thema);
                    } else {
            ...
            while (!Daten.filmeLaden.getStop() && it.hasNext()) {
                ...
                while (!Daten.filmeLaden.getStop() && (pos = strSeite1.indexOf(MUSTER_URL, pos)) != -1) {
                    ...
                    if (pos1 != -1 && pos2 != -1 && pos1 != pos2) {
                        ...
                        Log.fehlerMeldung(-203654812, "MediathekArte.themenSeiteSuchen", "keine Url addFilme" + nameSenderMReader + thema);
                    }
                }
            }
        }
        ...
        private void addFilme2(String strUrlFeed, String thema, String titel, String urlFilm) {
            ...
            if ((pos = strSeite2.indexOf(MUSTER_AUTH, pos)) != -1) {
                ...
                if (pos1 != -1 && pos2 != -1 && pos1 != pos2) {
                    ...
                    if (authurl.equals("")) {
                        Log.fehlerMeldung(-450983058, "MediathekArte.addFilme2", "keine Auth-Url" + nameSenderMReader + thema);
                    }
                }
            }
            //url suchen
            ...
            if ((pos = strSeite2.indexOf(MUSTER_URL, pos)) != -1) {
                ...
                if (pos1 != -1 && pos2 != -1 && pos1 != pos2) {
                    ...
                    if (!url.equals("")) {
                        ...
                        Log.fehlerMeldung(-462037812, "MediathekArte.addFilme2", "keine Url" + nameSenderMReader + thema);
                    }
                }
            }
        }
