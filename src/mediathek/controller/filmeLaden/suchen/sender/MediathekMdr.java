...
public class MediathekMdr extends MediathekReader implements Runnable {
    ...
    public void addToList() {
        ...
        while ((pos = seite.indexOf(MUSTER, pos)) != -1) {
            ...
            if (url.equals("")) {
                Log.fehlerMeldung(-889216307, Log.FEHLER_ART_MREADER, "MediathekMdr.addToList", "keine URL");
            } else {
                url = MUSTER_ADD + url;
        ...
        while ((pos = seite.indexOf(MUSTER_TAGE, pos)) != -1) {
            ...
            if (url.equals("")) {
                Log.fehlerMeldung(-461225808, Log.FEHLER_ART_MREADER, "MediathekMdr.addToList-2", "keine URL");
            } else {
    ...
    private class ThemaLaden implements Runnable {
        ...
        private MVStringBuilder seite4 = new MVStringBuilder(Konstanten.STRING_BUFFER_START_BUFFER);
        ...
        public void run() {
            try {
                ...
                Log.fehlerMeldung(-115896304, Log.FEHLER_ART_MREADER, "MediathekMdr.MdrThemaLaden.run", ex, "");
            }
            meldungThreadUndFertig();
        }
        ...
        void addTage(String urlSeite) {
            ...
            try {
                ...
                while (!Daten.filmeLaden.getStop() && (pos = seite1.indexOf(MUSTER_START_1, pos)) != -1) {
                    ...
                    if (url.equals("")) {
                        Log.fehlerMeldung(-392854069, Log.FEHLER_ART_MREADER, "MediathekMdr.addTage", new String[]{"keine URL: " + urlSeite});
                    } else {
                        url = MUSTER_ADD + url;
                        meldung(url);
                ...
                Log.fehlerMeldung(-556320478, Log.FEHLER_ART_MREADER, "MediathekMdr.addThema", ex, "");
            }
        }
        ...
        void addThema(String strUrlFeed) {
            ...
            try {
                ...
                while (!Daten.filmeLaden.getStop() && (pos = seite2.indexOf(MUSTER_URL, pos)) != -1) {
                    ...
                    if (pos != -1 && pos2 != -1) {
                        ...
                        if ((pos = seite2.indexOf(MUSTER_TITEL, pos)) != -1) {
                            ...
                            if (url.equals("")) {
                                Log.fehlerMeldung(-766250249, Log.FEHLER_ART_MREADER, "MediathekMdr.addThema", "keine URL: " + strUrlFeed);
                            } else {
                                meldung(url);
                ...
                Log.fehlerMeldung(-316874602, Log.FEHLER_ART_MREADER, "MediathekMdr.addThema", ex);
            }
        }
