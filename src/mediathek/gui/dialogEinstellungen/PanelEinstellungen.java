...
public class PanelEinstellungen extends PanelVorlage {
    ...
    public PanelEinstellungen(DDaten d) {
        ...
        jCheckBoxAbo.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ///////////////////////////////
                Daten.system[Konstanten.SYSTEM_ABOS_PFAD_NR] = Boolean.toString(jCheckBoxAbo.isSelected());
            }
        });
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("max. parallele Downloads beim Laden der Downloads:");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("Abos"));

        jCheckBoxAbo.setText("im Downloadverzeichnis für jedes Abo einen Unterordner");

        jLabel2.setText("mit dem Abonamen anlegen");
