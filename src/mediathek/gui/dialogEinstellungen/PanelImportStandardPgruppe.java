...
public class PanelImportStandardPgruppe extends PanelVorlage {
    ...
    private void initBeob() {
        ...
        jButtonHilfe.addActionListener(new ActionListener() {
            ...
            @Override
            public void actionPerformed(ActionEvent e) {
                new DialogHilfe(null, false, new GetFile().getHilfeSuchen(GetFile.PFAD_HILFETEXT_STANDARD_PGRUPPEN)).setVisible(true);
            }
        });
    }
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jButtonHilfe, jButtonReset, jButtonUebernehmen});
