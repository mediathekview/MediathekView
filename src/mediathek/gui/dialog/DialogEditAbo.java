...
//            panel.add(checkBoxExakt);
    ...
    private void check() {
        aktAbo.arr[DatenAbo.ABO_ZIELPFAD_NR] = GuiFunktionen.replaceLeerDateiname(aktAbo.arr[DatenAbo.ABO_ZIELPFAD_NR], false /* pfadtrennerEntfernen */, false /* leerEntfernen */);
        ok = true;
    }
