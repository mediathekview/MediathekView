...
public class DatenPset {
    ...
    public static final int PROGRAMMSET_ADD_ON_NR = 13;
    public static final String PROGRAMMSET_BESCHREIBUNG = "Beschreibung";
    public static final int PROGRAMMSET_BESCHREIBUNG_NR = 14;
    public static final String PROGRAMMSET_BUTTON_1 = "Button-1";
    public static final int PROGRAMMSET_BUTTON_1_NR = 15;
    public static final String PROGRAMMSET_BUTTON_2 = "Button-2";
    public static final int PROGRAMMSET_BUTTON_2_NR = 16;
    public static final int PROGRAMMSET_MAX_ELEM = 17;
    public static final String[] PROGRAMMSET_COLUMN_NAMES = {PROGRAMMSET_NAME, PROGRAMMSET_PRAEFIX_DIREKT, PROGRAMMSET_SUFFIX_DIREKT,
        ...
        PROGRAMMSET_LAENGE_BESCHRAENKEN, PROGRAMMSET_MAX_LAENGE, PROGRAMMSET_ADD_ON,
        PROGRAMMSET_BESCHREIBUNG,
        PROGRAMMSET_BUTTON_1, PROGRAMMSET_BUTTON_2};
